                ...
                <form class="form-inline mr-auto">
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?php echo base_url('assets/admin/assets/img/products/product-3-50.png'); ?>" alt="product">
                    ...
                    <ul class="sidebar-menu active">
                        ...
                        <li class="nav-item dropdown ">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?php echo site_url('ongkosKirim'); ?>"> <i class="fas fa-money-check-alt"></i>Ongkos Kirim</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('member'); ?>" class="nav-link"><i class="fas fa-user"></i><span>Member</span></a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('toko'); ?>" class="nav-link"><i class="fas fa-store"></i><span>Toko</span></a>
                        </li>
                    </ul>
                </aside>
            </div>
