    ...
    <div id="app">
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <a href="<?= site_url('home'); ?>" class="navbar-brand sidebar-gone-hide">tokokitaaja</a>
                ...
                <a href="<?= site_url('memberpanel'); ?>" class="btn btn-outline-light mr-2">Hai <?= $username; ?></a>
                <a href="<?= site_url('memberpanel/logout'); ?>" class="btn btn-outline-light">LogOut</a>
            </nav>

            <nav class="navbar navbar-secondary navbar-expand-lg mb-5">
                <div class="container">
                    <!-- <?= var_dump($id) ?> -->
